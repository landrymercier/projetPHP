...
<html>
    ...
    <body id="logged_ifrocean">
        ...
        if (isset($_GET['valider']) == "groupe") {
            ...
            echo"<a href='clore.php?valider=groupe&groupeid=" . $_GET['groupeid'] . "' class='bouton'>Valider</a>";
            echo"</p>";
            echo"</div>";
            echo"</form>";
        }
...
//FERMETURE D'UN PROJET
        if (isset($_GET['valider']) == "projet") {
            ...
            echo"<p><a href='index.php' class='bouton'>Retour</a>";
            echo"<a href='clore.php?valider=projet&id=" . $_GET['groupeid'] . "' class='bouton'>Valider</a>";
            echo"</p>";
            echo"</div>";
            echo"</form>";
        }
